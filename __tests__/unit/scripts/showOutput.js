/**
 * __tests__/unit/scripts/showOutput.js
 * Test: scripts/_showOutput.js
 */
'use strict';

const showOutput = require('scripts/_showOutput');
...
describe('Console messaging', () => {
	...
	test('the color coded message (fail) is correct', () => {
		...
		expect.assertions(1);
		expect(output).toBe('\u001b[37m\u001b[31mfail\u001b[37m \u001b[35mdescription\u001b[37m message\u001b[39m');
	});
});