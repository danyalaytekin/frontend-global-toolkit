/**
 * __tests__/unit/scripts/get-new-package-options.js
 * Test: scripts/_get-new-package-options.js
 */
'use strict';

const path = require('path');
const rewire = require('rewire');
const tasks = rewire(path.resolve(__dirname, '../../../scripts/_get-new-package-options'));
